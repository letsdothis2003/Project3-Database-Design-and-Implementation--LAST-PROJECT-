...
SELECT 'Instructor Data' as TableHeader, * FROM Data.Instructor; 
...
SELECT 'DepartmentInstructor Data' as TableHeader, * FROM Data.DepartmentInstructor;
SELECT 'Section Data Table' as TableHeader, * FROM Data.Section;
SELECT 'serAuthorization Data' as TableHeader, * FROM DbSecurity.UserAuthorization;
